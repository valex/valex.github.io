...
class PAGE_APP {
    ...
    constructor() {
        ...
        this.vectors = {
            a: new SVGVector2D(-2.0, 3.0, {
                id: 'vector_a',
                html_label: "a&#773;",
            }),
            b: new SVGVector2D(2.2, 1.5, {
                id: 'vector_b',
                html_label: "b&#773;",
            }),
            result: new SVGVector2D(-4.2, 1.5, {
                id: 'result_vector',
                color: '#FF0000',
                html_label: "a&#773; - b&#773;",
                html_label_min_width: 500
            }),
            b_moved: new SVGVector2D(-2.2, -1.5, {
                id: 'b_moved_vector',
                color: '#AAAAAA',
                dasharray: '3 2'
            }, -2.0, 3.0)
    ...
    init(){
        ...
        d3.select('#t_a_x').on('input', function(e){
            ...
            APP.vectors.result.x = x - APP.vectors.b.x;
        ...
        d3.select('#t_a_y').on('input', function(e){
            ...
            APP.vectors.result.y = y - APP.vectors.b.y;
        ...
        d3.select('#t_b_x').on('input', function(e){
            ...
            APP.vectors.result.x = -x + APP.vectors.a.x;
        ...
        d3.select('#t_b_y').on('input', function(e){
            ...
            APP.vectors.result.y = -y + APP.vectors.a.y;
        ...
        this.drawVector(this.vectors.result);
    ...
    drawInfoBlock(){
        ...
        this.mainGroup.append('text')
            .attr('id', 'result_vector_info')
            .html(this.result_vectorInfo())
            .style('text-anchor', 'start')
            .style('alignment-baseline', 'bottom')
            .attr('fill',"#333")
            .attr('opacity', 0.7)
    ...
    a_dragged(event){
        ...
        APP.vectors.result.x = APP.scaleX.invert(x)-APP.vectors.b.x;
        APP.vectors.result.y = APP.scaleY.invert(y)-APP.vectors.b.y;
    ...
    b_dragged(event){
        ...
        APP.vectors.result.x = -APP.scaleX.invert(x)+APP.vectors.a.x;
        APP.vectors.result.y = -APP.scaleY.invert(y)+APP.vectors.a.y;
    ...
    update(){
        ...
        d3.select('#'+this.vectors.result.id)
            .attr("x2", this.scaleX(this.vectors.result.x))
            .attr("y2", this.scaleY(this.vectors.result.y));
        ...
        d3.select('#'+this.vectors.result.id + '_label')
            .attr('x',this.scaleX(this.vectors.result.x/2))
            .attr('y',this.scaleY(this.vectors.result.y/2))
            .attr("transform", "rotate("+(-this.vectors.result.angle)+","+this.scaleX(this.vectors.result.x / 2)+","+this.scaleY(this.vectors.result.y / 2)+")")
        ...
        d3.select('#'+this.vectors.result.id + '_x_component')
            .attr("x1", this.scaleX(this.vectors.result.x))
            .attr("y1", this.scaleY(this.vectors.result.y))
            .attr("x2", this.scaleX(this.vectors.result.x))
            .attr("y2", this.scaleY(0))

        d3.select('#'+this.vectors.result.id + '_y_component')
            .attr("x1", this.scaleX(this.vectors.result.x))
            .attr("y1", this.scaleY(this.vectors.result.y))
            .attr("x2", this.scaleX(0))
            .attr("y2", this.scaleY(this.vectors.result.y))
    ...
    result_vectorInfo() {
        ...
        info+=this.vectors.result.x.toFixed(2);
        info+=", ";
        info+=this.vectors.result.y.toFixed(2);
